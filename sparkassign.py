# -*- coding: utf-8 -*-
"""
Created on Sun Apr  4 17:28:37 2021
...
df_parquet = spark.read.parquet('D:/sparkdata/consumerInternet.parquet')
df_csv = spark.read.option("header",True).csv('D:/sparkdata/startup.csv')
